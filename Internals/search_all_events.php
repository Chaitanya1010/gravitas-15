	...
	if((isset($_SESSION['regno']))&&(isset($_REQUEST['val'])))
{
	...
	while($arr = mysqli_fetch_array($res))
	{
		...
		<TD><button id='$arr[0]' name ='$arr[0]' onclick='excel_eventlist(this.id)'class='waves-effect waves-light indigo darken-2 btn z-depth-1'><i class='material-icons'>play_for_work</i></button></TD></TR>";
	}
	echo"</TABLE>";
}
