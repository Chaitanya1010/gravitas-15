<?php
	...
	if((isset($_SESSION['name_fin']))&&(isset($_REQUEST['id'])))//session_variable verification
	{
		echo"
			...
			Phone number:<input type='text' maxlength='10' name='phno_shirts_add'  placeholder='9092******' id='phno_shirts_add' autocomplete='off' onkeypress='return isNumber(event)'></br><br>
