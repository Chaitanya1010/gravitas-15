<?php
	...
	if((isset($_SESSION['name_fin']))&&(isset($_REQUEST['number_external'])))//session_variable verification
	{
		...
		$sql_add_externals="INSERT INTO `finance`.`data_externals` (`number_external`, `amount_external`, `update_ext_date`, `update_ext_id`, `remarks_external`, `approval_1`, `approval_2`, `approval_3`) VALUES ('$number_external', '$amount_external', '$update_ext_date', '$update_ext_id', '$remarks_external', '0', '0', '0');";
	...
	//redirect to login page from log-out
