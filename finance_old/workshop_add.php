<?php
	...
	if((isset($_SESSION['name_fin']))&&(isset($_REQUEST['id'])))//session_variable verification
	{
		echo"
			...
			Phone Number:<input type='text' maxlength='10' name='phno_workshop' id='phno_workshop' placeholder='9092******' autocomplete='off' onkeypress='return isNumber(event)'><br><br>
