...
//********************************************************************************************************
		...
		else if($selected==3)	//Net
		{
			...
			$sql_add_net= "INSERT INTO `finance`.`mode_net` (`trans_id`, `bank_name_net`, `issue_date_net`, `category`, `unique_id_basic`) VALUES ('$trans_id', '$bank_name_net', '$issue_date_net', '5', '$id');";
